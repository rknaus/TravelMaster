...
/**
 * Displays a separate window with all departure time from a start station to a 
 * destination station
 * 
...
public class DepartureWindow {
	...
	/**
	 * Creates the window of a departure list
	 */
	private void createFrame() {
		...
		for (DepartureItem departureItem : departureItems) {
			...
			// sets an alternating background color
		...
		// sets parameters like size, visibility, etc.
